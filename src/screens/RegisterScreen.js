...
const styles = StyleSheet.create({
  ...
  backButton: {
      ...
      padding: 8, backgroundColor: '#F5F6FA', borderRadius: 20
  },
  ...
  inputStyle: {
      backgroundColor: '#F5F6FA', borderRadius: 15, paddingHorizontal: 10, borderBottomWidth: 0
  },
  ...
  // NUEVO ESTILO PARA CANCELAR: Visible pero secundario
  btnCancelNative: {
      marginTop: 15,
      paddingVertical: 14,
      borderRadius: 30,
      borderWidth: 1,
      borderColor: '#E0E0E0', // Borde gris visible
